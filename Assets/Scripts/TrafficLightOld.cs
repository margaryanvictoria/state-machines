...
/* Old TrafficLight script where we created our own State Machine, but it's too messy. */
public class TrafficLightOld : MonoBehaviour {
	...
	private void Start() {
		this.states.Add(LightState.Red, this.RedState);
		this.states.Add(LightState.Yellow, this.YellowState);
		this.states.Add(LightState.Green, this.GreenState);
